...
module cpld_model(
    ...
    input  wire uart_rdn,         //读串口信号，低有�?
    input  wire uart_wrn,         //写串口信号，低有�?
    output reg uart_dataready,    //串口数据准备�?
    output reg uart_tbre,         //发�?�数据标�?
    output reg uart_tsre,         //数据发�?�完毕标�?
    inout  wire [7:0]data
);
